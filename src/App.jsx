          ...
          {activeSection === 'atom' && (
            <div className="mt-6 space-y-6 p-4 bg-gray-50 rounded-lg">
              <div className="space-y-6">
                ...
                {/* Section II: Thông tin thú vị và ứng dụng thực tế */}
                <div className="bg-blue-50 p-6 rounded-lg shadow-sm">
                  <h2 className="text-2xl font-semibold text-red-600 flex items-center gap-2 mb-4">
                    <TestTube size={24} className="text-red-500" />
                ...
                {/* Section III: Mẹo học tập hiệu quả */}
                ...
                {/* Section IV: Câu hỏi tự luyện tập và đáp án */}
              ...
              <div className="mt-8">
                ...
                <div className="aspect-video">
                  <iframe 
                    ...
                    src="https://www.youtube.com/embed/LhveTGblGHY" 
