              ...
              <div className="space-y-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  ...
                  <p className="italic text-gray-600">
                    *Ghi chú: Hãy nhớ rằng mỗi nguyên tử đều là một phần của câu chuyện vĩ đại về vũ trụ. Chúng hiện diện trong mọi hơi thở, mọi suy nghĩ và mọi khoảnh khắc của cuộc sống!
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8">
                ...
                <div className="aspect-video">
                  <iframe 
                    ...
                    src="https://www.youtube.com/watch?v=LhveTGblGHY" 
